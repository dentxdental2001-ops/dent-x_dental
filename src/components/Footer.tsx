...
export default function Footer() {
  return (
    <footer className="mt-24" style={{ background: "var(--footer-bg)" }}>
      <div className="max-w-7xl mx-auto px-6 py-20 text-[var(--footer-text)]">
          ...
          <div>
            ...
            <div className="space-y-6 text-sm">
              ...
              <div className="flex items-center gap-3">
                <Phone size={18} className="text-[#2FA4C5] flex-shrink-0" />
                <a
              ...
              {/* Email */}
              <div className="flex items-center gap-3">
                <Mail size={18} className="text-[#2FA4C5] flex-shrink-0" />
                <a
              ...
              <div className="flex items-start gap-3">
                <MapPin
                  size={18}
                  className="text-[#2FA4C5] mt-[2px] flex-shrink-0"
                />
                <a
                ...
                >
                  ...
                  Gujarat Housing Board, Kotecha Nagar, Rajkot,
                  Gujarat 360001
                </a>
              </div>
        ...
        {/* Divider */}
        <div className="border-t border-white/20 mt-16 pt-8 text-center text-sm">
